...
def get_local_filenames(substring=None):
    '''If zip files are located in a local directory, get the list of
    filenames.  If prefix is not None, then search for filenames that
    match a prefix.'''
    key_list=[]
...
if __name__ == '__main__':
    ...
    #prefixes = ['patientmedication_', 'medication_']
    ...
    #keys = get_local_filenames(substring=substring)
